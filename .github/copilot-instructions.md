...
- [x] Implement additional common design patterns
- [x] Create JUnit tests with AssertJ
- [x] Create Cucumber tests with AssertJ
- [x] Configure Gradle build and test tasks
